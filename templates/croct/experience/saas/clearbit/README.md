...
This template defines a personalized experience for SaaS visitors identified through [Clearbit](https://clearbit.com)
firmographic data.
...
It leverages the industry, company size, and other firmographic attributes ingested from Clearbit to align onsite
content with the high-intent accounts you target, reinforcing your value proposition on every visit.

> [!IMPORTANT]
> Make sure you have completed the [Clearbit data activation](https://docs.croct.com/immersion/tutorials/clearbit-data-activation)
> integration before using this template. Since Clearbit usually takes a few moments to load, the firmographic data
...
```croct-cmd
croct use croct://experience/saas/clearbit
```
