...
This template defines a personalized experience for SaaS visitors identified through [ZoomInfo](https://www.zoominfo.com)
firmographic data.
...
It leverages the industry, company size, and other firmographic attributes ingested from ZoomInfo to align onsite
content with the high-intent accounts you target, reinforcing your value proposition on every visit.

> [!IMPORTANT]
> Make sure you have completed the [ZoomInfo data activation](https://docs.croct.com/immersion/tutorials/zoominfo-data-activation)
> integration before using this template. Since ZoomInfo usually takes a few moments to load, the firmographic data
...
```croct-cmd
croct use croct://experience/saas/zoominfo
```
