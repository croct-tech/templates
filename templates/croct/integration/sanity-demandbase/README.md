...
Looking to personalize your **Sanity-powered site for target accounts** using **Demandbase data**?
...
[Demandbase data activation](https://docs.croct.com/immersion/integrations/firmographics/demandbase) first. Until data flows
...
```croct-cmd
croct use croct://integration/sanity-demandbase
```
