...
Looking to personalize your **Sanity-powered site for target accounts** using **ZoomInfo data**?
...
[ZoomInfo data activation](https://docs.croct.com/immersion/integrations/firmographics/zoominfo) first. Until data flows
...
```croct-cmd
croct use croct://integration/sanity-zoominfo
```
