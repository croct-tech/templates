      ...
      <div className="container py-6 sm:px-6">
        <div className="flex items-center justify-between gap-5">
          <Link className="flex items-center gap-2" href="/">
            ...
            >
              <mask id="mask0_3501_55" style={{maskType: "alpha"}} maskUnits="userSpaceOnUse" x="0" y="0" width="256" height="256">
                <circle cx="128" cy="128" r="128" fill="black"/>
              </mask>
              <g mask="url(#mask0_3501_55)">
                <rect width="256" height="256" fill="white"/>
                <path fillRule="evenodd" clipRule="evenodd" d="M0 256V0H256V256H234.546C234.546 197.162 186.849 149.454 128 149.454C69.1625 149.454 21.4539 197.151 21.4539 256H0ZM72.71 256C72.71 225.599 97.3514 200.96 127.756 200.96C158.16 200.96 182.801 225.61 182.79 256H72.71Z" fill="#4DD684"/>
              </g>
            </svg>
            <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <nav className="">
            ...
            >
              ...
              <li className="sm:before:w-[1px] sm:before:bg-gray-100 before:block flex sm:gap-4 md:gap-6">
                <Link
                    className="rounded-full flex gap-2 items-center bg-black hover:bg-gray-800 focus:bg-cyan-500 p-1 sm:py-3 sm:px-6 text-white transition-colors duration-200"
                    href="https://croct.com/templates/boilerplate/starter/sanity"
                    target="_blank"
                >
                  <span className="sr-only sm:not-sr-only">View template</span>
                  <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
