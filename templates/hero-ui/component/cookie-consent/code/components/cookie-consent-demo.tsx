      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
        <div className="max-w-lg w-full text-center mb-6">
          ...
          <p className="text-default-600 mb-4">
            This page shows an example of how to implement a cookie consent component using <Link href="https://heroui.ai">Hero UI</Link> and <Link href="https://croct.com">Croct</Link>.
          </p>
          <Button
            variant="flat"
            onPress={reset}
