...
export default function Page({content}: PageProps) {
  return (
    <TemplateCanvas
      ...
      ctaLink="%workspaceUrl%/slots/edit/%slotId%/%slotVersion%?utm_medium=cli&utm_source=template&utm_campaign=00000000.CO.DE.magic_ui&utm_content=avatar_circles&tum_term=nextjs"
      ctaTarget="_blank"
      src="#"
      fullScreen
      portal
