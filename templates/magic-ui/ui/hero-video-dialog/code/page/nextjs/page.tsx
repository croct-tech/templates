...
export default async function Page() {
  ...
  return (
    <TemplateCanvas
      ...
      ctaLink="%workspaceUrl%/slots/edit/%slotId%/%slotVersion%?utm_medium=cli&utm_source=template&utm_campaign=00000000.CO.DE.magic_ui&utm_content=hero_video_dialog&tum_term=nextjs"
      ctaTarget="_blank"
      src="#"
      fullScreen
      portal
