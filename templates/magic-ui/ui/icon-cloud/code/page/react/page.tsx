...
export default function Page() {
  ...
  return (
    <TemplateCanvas
      ...
      ctaLink="%workspaceUrl%/slots/edit/%slotId%/%slotVersion%?utm_medium=cli&utm_source=template&utm_campaign=00000000.CO.DE.magic_ui&utm_content=icon_cloud&tum_term=react"
      ctaTarget="_blank"
      src="#"
      fullScreen
      portal
