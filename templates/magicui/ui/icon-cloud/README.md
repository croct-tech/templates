...
This template adds the [Magic UI Icon Cloud](https://magicui.design/docs/components/icon-cloud) component to your 
...
```js-pm
croct@latest use magicui://ui/icon-cloud
```

You can customize the template by specifying options:

```js-pm
croct@latest use magicui://ui/icon-cloud --router=page
```
