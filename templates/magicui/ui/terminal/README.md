...
This template adds the [Magic UI Terminal](https://magicui.design/docs/components/terminal) component to your 
...
```js-pm
croct@latest use magicui://ui/terminal
```

You can customize the template by specifying options:

```js-pm
croct@latest use magicui://ui/terminal --router=page
```
