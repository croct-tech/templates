...
export default function Page() {
  ...
  return (
    <TemplateCanvas
      ...
      ctaLink="%workspaceUrl%/slots/edit/%slotId%/%slotVersion%?utm_medium=cli&utm_source=template&utm_campaign=00000000.CO.DE.mantine&utm_content=hero_content_left&utm_term=react"
      ctaTarget="_blank"
      fullScreen
      isolated
    >
