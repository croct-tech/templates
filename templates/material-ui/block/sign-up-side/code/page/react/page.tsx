  ...
  return (
    <>
      ...
      <LinkButton
        ...
        href="%workspaceUrl%/slots/edit/%slotId%/%slotVersion%?utm_medium=cli&utm_source=template&utm_campaign=00000000.CO.DE.material_ui&utm_content=sign_up_section&utm_term=react"
        target="_blank"
